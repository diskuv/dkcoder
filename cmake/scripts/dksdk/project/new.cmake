  ...
  "configurePresets": [
    {
      ...
      "cacheVariables": {
        ...
        "DKSDK_OPAM_REPOSITORY": "git+file://${sourceDir}/fetch/dksdk-opam-repository",
        "DKSDK_OPAM_REPOSITORY_JS": "git+file://${sourceDir}/fetch/dksdk-opam-repository-js",
...
function(run)
    ...
    file(CONFIGURE OUTPUT ${OUTPUT_DIR}/CMakeUserPresets.json
        CONTENT "${cmake_user_presets}" @ONLY NEWLINE_STYLE LF)
